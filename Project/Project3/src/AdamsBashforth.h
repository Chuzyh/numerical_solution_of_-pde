...
public:
    ...
    static pIVPsolver createIVPsolver() { return pIVPsolver(new AdamsBashforth_solver()); }
...
void register_ABF()
{
    ...
    F.registerProduct("AdamsBashforth",[](){return AdamsBashforth_solver::createIVPsolver();});
}
#endif